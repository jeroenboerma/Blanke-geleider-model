...
#Define component
def Component():
    Material = "Aluminium"     #Choose "Copper", "Aluminium", "Al. alloy"
...
def dimensions():
    ...
    Width = Import_from_excel.import_col(location, filename, 'Rechthoekig', 'A', 29, 47)/1000
    Thickness = Import_from_excel.import_col(location, filename, 'Rechthoekig', 'B', 29, 47)/1000
